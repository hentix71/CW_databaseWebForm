    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="chart-container">
                <h2>Theatre Visualization</h2>
                <div class="chart-wrapper">
                    <asp:Chart ID="Chart1" runat="server" DataSourceID="TheatreTable" Width="800px" Height="400px">
                        <Series>
                            <asp:Series Name="Theatre Data" ChartType="Column" XValueMember="THEATRENAME" YValueMembers="THEATREID"></asp:Series>
                        </Series>
                        <ChartAreas>
